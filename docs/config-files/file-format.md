...
| `$kind`            | string  |    no     | Describes the purpose of this parameter, allowing applications to understand what a parameter does without parsing labels. See [Parameter kinds](config-files/parameter-kinds.md) for the list of available kinds.                                                                                                                                  |
