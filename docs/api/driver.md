...
- `showLogo`: By default, Z-Wave JS prints an ASCII logo on driver startup. Setting this to `false` will disable the logo (version information is still printed). Default: `true`.
