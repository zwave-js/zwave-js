...
test("returns true when a non-partial CC is received", async ({
	context,
	expect,
}) => {
...
test("returns true when a partial CC is received that expects no more reports", async ({
	context,
	expect,
}) => {
	const { driver } = context;
...
test("returns false when a partial CC is received that expects more reports", async ({
	context,
	expect,
}) => {
	const { driver } = context;
...
test("returns true when the final partial CC is received and merges its data", async ({
	context,
	expect,
}) => {
	const { driver } = context;
...
test("returns false when a partial CC throws Deserialization_NotImplemented during merging", async ({
	context,
	expect,
}) => {
	const { driver } = context;
...
test("returns false when a partial CC throws CC_NotImplemented during merging", async ({
	context,
	expect,
}) => {
	const { driver } = context;
...
test("returns false when a partial CC throws PacketFormat_InvalidPayload during merging", async ({
	context,
	expect,
}) => {
	const { driver } = context;
