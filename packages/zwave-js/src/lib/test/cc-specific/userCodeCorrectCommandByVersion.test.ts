...
integrationTest("UserCodeCCAPI.clear uses Extended User Code Set on V2 nodes", {
	// debug: true,
...
integrationTest("UserCodeCCAPI.set uses legacy Set command on V1 nodes", {
	// debug: true,
...
integrationTest("UserCodeCCAPI.clear uses legacy Set command on V1 nodes", {
	// debug: true,
