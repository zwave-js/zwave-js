	...
	implements EndpointId, SupportsCC, ControlsCC, IsCCSecure, ModifyCCs, GetCCs
{
	...
	/** Allows checking whether a CC API is supported before calling it with {@link EndpointBase.invokeCCAPI} */
	 ...
	 * Use {@link EndpointBase.supportsCCAPI} to check support first.
	 */
	public invokeCCAPI<
