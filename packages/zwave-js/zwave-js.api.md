...
//
// src/lib/controller/Controller.ts:916:2 - (ae-missing-getter) The property "provisioningList" has a setter but no getter.
...
// src/lib/driver/Driver.ts:8347:5 - (tsdoc-param-tag-missing-hyphen) The @param block should be followed by a parameter name and then a hyphen
// src/lib/driver/Driver.ts:8350:2 - (ae-unresolved-link) The @link reference could not be resolved: The package "zwave-js" does not have an export "getAvailableFirmwareUpdates"
