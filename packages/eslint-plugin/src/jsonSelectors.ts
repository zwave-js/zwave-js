...
export const CONFIG_OPTIONS = `${CONFIG_PARAM} > JSONProperty[key.value='options']`;
export const CONFIG_OPTION = `${CONFIG_OPTIONS} > JSONArrayExpression > JSONObjectExpression`;
