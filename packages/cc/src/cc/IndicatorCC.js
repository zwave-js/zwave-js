...
import { CommandClasses, Indicator, MessagePriority, ValueMetadata, ZWaveError, ZWaveErrorCodes, encodeBitMask, getIndicatorProperty, parseBitMask, validatePayload, } from "@zwave-js/core";
...
import { IndicatorCommand } from "../lib/_Types.js";
...
function indicatorObjectsToTimeout(values) {
    ...
    const minutes = (timeoutValues.find((v) => v.propertyId === 0x06)?.value
        ?? 0);
    const seconds = clamp(timeoutValues.find((v) => v.propertyId === 0x07)
        ?.value ?? 0, 0, 59)
        + clamp(timeoutValues.find((v) => v.propertyId === 0x08)
            ?.value ?? 0, 0, 99)
            / 100;
    return {
        hours,
...
export const IndicatorCCValues = V.defineCCValues(CommandClasses.Indicator, {
    ...
    ...V.dynamicPropertyAndKeyWithName("supportedPropertyIDs", "supportedPropertyIDs", (indicatorId) => indicatorId, ({ property, propertyKey }) => property === "supportedPropertyIDs"
        && typeof propertyKey === "number", undefined, { internal: true }),
    ...V.dynamicPropertyAndKeyWithName("valueV2", 
    ...
    ...V.dynamicPropertyAndKeyWithName("timeout", (indicatorId) => indicatorId, 
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    (indicatorId) => "timeout", ({ property, propertyKey }) => typeof property === "number" && propertyKey === "timeout", (indicatorId) => ({
    ...
    ...V.dynamicPropertyWithName("indicatorDescription", (indicatorId) => indicatorId, ({ property }) => typeof property === "number", undefined, { internal: true, minVersion: 4 }),
});
/**
...
function getIndicatorMetadata(indicatorId, propertyId, overrideIndicatorLabel) {
    ...
    const baseMetadata = IndicatorCCValues.valueV2(indicatorId, propertyId).meta;
    if (!prop) {
        return {
            ...baseMetadata,
            ...ValueMetadata.UInt8,
...
function getIndicatorLabel(indicatorId, propertyId, overrideIndicatorLabel, overridePropertyLabel) {
    ...
    if (indicatorId >= Indicator["LCD backlight"]
...
export function shouldExposeIndicatorValue(indicatorId, propertyId) {
...
let IndicatorCCAPI = (() => {
    let _classDecorators = [API(CommandClasses.Indicator)];
    ...
    var IndicatorCCAPI = class extends _classSuper {
        ...
        static {
            ...
            _getSupported_decorators = [validateArgs()];
            _reportSupported_decorators = [validateArgs()];
            _reportDescription_decorators = [validateArgs()];
            _setTimeout_decorators = [validateArgs()];
            _getTimeout_decorators = [validateArgs()];
            _getDescription_decorators = [validateArgs()];
            ...
            __esDecorate(this, null, _getSupported_decorators, { kind: "method", name: "getSupported", static: false, private: false, access: { has: obj => "getSupported" in obj, get: obj => obj.getSupported }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _reportSupported_decorators, { kind: "method", name: "reportSupported", static: false, private: false, access: { has: obj => "reportSupported" in obj, get: obj => obj.reportSupported }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _reportDescription_decorators, { kind: "method", name: "reportDescription", static: false, private: false, access: { has: obj => "reportDescription" in obj, get: obj => obj.reportDescription }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _getTimeout_decorators, { kind: "method", name: "getTimeout", static: false, private: false, access: { has: obj => "getTimeout" in obj, get: obj => obj.getTimeout }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _getDescription_decorators, { kind: "method", name: "getDescription", static: false, private: false, access: { has: obj => "getDescription" in obj, get: obj => obj.getDescription }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            IndicatorCCAPI = _classThis = _classDescriptor.value;
            ...
            return async function ({ property, propertyKey }, value) {
                ...
                if (property === "value") {
                    ...
                    if (typeof value !== expectedType) {
                        throwWrongValueType(this.ccId, property, expectedType, typeof value);
                    }
                    return this.set([
                        {
                            indicatorId,
        ...
        async set(value) {
            ...
            if (this.version === 1 && typeof value !== "number") {
                throw new ZWaveError(`Node ${this.endpoint
                    .nodeId} only supports IndicatorCC V1 which requires a single value to be set`, ZWaveErrorCodes.Argument_Invalid);
            }
            else if (this.version >= 2
                && isArray(value)
                && value.length > MAX_INDICATOR_OBJECTS) {
                throw new ZWaveError(`Only ${MAX_INDICATOR_OBJECTS} indicator values can be set at a time!`, ZWaveErrorCodes.Argument_Invalid);
            }
        ...
        async reportSupported(indicatorId, supportedProperties, nextIndicatorId) {
            this.assertSupportsCommand(IndicatorCommand, IndicatorCommand.SupportedReport);
        ...
        async reportDescription(indicatorId, description) {
            this.assertSupportsCommand(IndicatorCommand, IndicatorCommand.DescriptionReport);
        ...
        async identify() {
            if (this.version < 3) {
                throw new ZWaveError(`The identify command is only supported in Indicator CC version 3 and above`, ZWaveErrorCodes.CC_NotSupported);
            }
            return this.set([
                {
                    indicatorId: 0x50,
        ...
        async setTimeout(indicatorId, timeout) {
            ...
            if (this.version < 3) {
                throw new ZWaveError(`The setTimeout command is only supported in Indicator CC version 3 and above`, ZWaveErrorCodes.CC_NotSupported);
            }
            if (typeof timeout === "string") {
                if (timeout === "") {
                    ...
                    if (!parsed) {
                        throw new ZWaveError(`The timeout string "${timeout}" is not valid`, ZWaveErrorCodes.Argument_Invalid);
                    }
                    timeout = parsed;
                }
            }
            ...
            if (timeout) {
                ...
                if (hours) {
                    if (!supportedPropertyIDs?.includes(0x0a)) {
                        throw new ZWaveError(`The indicator ${indicatorId} does not support setting the timeout in hours`, ZWaveErrorCodes.Argument_Invalid);
                    }
                    objects.push({
                        indicatorId,
                        propertyId: 0x0a,
                ...
                if (minutes) {
                    if (!supportedPropertyIDs?.includes(0x06)) {
                        throw new ZWaveError(`The indicator ${indicatorId} does not support setting the timeout in minutes`, ZWaveErrorCodes.Argument_Invalid);
                    }
                    objects.push({
                        indicatorId,
                        propertyId: 0x06,
                ...
                if (seconds) {
                    if (!supportedPropertyIDs?.includes(0x07)) {
                        throw new ZWaveError(`The indicator ${indicatorId} does not support setting the timeout in seconds`, ZWaveErrorCodes.Argument_Invalid);
                    }
                    objects.push({
                        indicatorId,
                        propertyId: 0x07,
                ...
                if (hundredths) {
                    if (!supportedPropertyIDs?.includes(0x08)) {
                        throw new ZWaveError(`The indicator ${indicatorId} does not support setting the timeout in 1/100 seconds`, ZWaveErrorCodes.Argument_Invalid);
                    }
                    objects.push({
                        indicatorId,
                        propertyId: 0x08,
        ...
        async getDescription(indicatorId) {
            this.assertSupportsCommand(IndicatorCommand, IndicatorCommand.DescriptionGet);
    ...
    return IndicatorCCAPI = _classThis;
})();
export { IndicatorCCAPI };
let IndicatorCC = (() => {
    let _classDecorators = [commandClass(CommandClasses.Indicator), implementedVersion(4), ccValues(IndicatorCCValues)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = CommandClass;
    var IndicatorCC = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            IndicatorCC = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        async interview(ctx) {
            ...
            const api = CCAPI.create(CommandClasses.Indicator, ctx, endpoint).withOptions({
            ...
            if (api.version > 1) {
                ...
                this.setValue(ctx, IndicatorCCValues.supportedIndicatorIds, supportedIndicatorIds);
        ...
        async refreshValues(ctx) {
            ...
            if (api.version === 1) {
                ...
                const supportedIndicatorIds = this.getValue(ctx, IndicatorCCValues.supportedIndicatorIds) ?? [];
                for (const indicatorId of supportedIndicatorIds) {
                    ctx.logNode(node.id, {
                        endpoint: this.endpointIndex,
                        message: `requesting current indicator value (id = ${num2hex(indicatorId)})...`,
                        direction: "outbound",
                    });
        ...
        translateProperty(ctx, property, propertyKey) {
            if (typeof property === "number") {
                if (typeof propertyKey === "number" || propertyKey === "timeout") {
                    ...
                    if (property in Indicator)
                        return Indicator[property];
                }
            }
        ...
        supportsV2Indicators(ctx) {
            ...
            return supportedIndicatorIds.some((indicatorId) => !!this.getValue(ctx, IndicatorCCValues.supportedPropertyIDs(indicatorId))?.length);
        }
        getManufacturerDefinedIndicatorLabel(ctx, indicatorId) {
            if (isManufacturerDefinedIndicator(indicatorId)) {
                return this.getValue(ctx, IndicatorCCValues.indicatorDescription(indicatorId));
            }
        }
        static getSupportedPropertyIDsCached(ctx, endpoint, indicatorId) {
            return ctx
                .getValueDB(endpoint.nodeId)
                .getValue(IndicatorCCValues.supportedPropertyIDs(indicatorId).endpoint(endpoint.index));
        }
    };
    return IndicatorCC = _classThis;
})();
export { IndicatorCC };
let IndicatorCCSet = (() => {
    let _classDecorators = [CCCommand(IndicatorCommand.Set), useSupervision()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = IndicatorCC;
    var IndicatorCCSet = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            IndicatorCCSet = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor(options) {
...
· indicatorId: ${v.indicatorId}
  ...
  value:       ${v.value}`)
    ...
    return IndicatorCCSet = _classThis;
})();
export { IndicatorCCSet };
let IndicatorCCReport = (() => {
    let _classDecorators = [CCCommand(IndicatorCommand.Report)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = IndicatorCC;
    var IndicatorCCReport = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            IndicatorCCReport = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor(options) {
        ...
        persistValues(ctx) {
            ...
            if (this.indicator0Value != undefined) {
                ...
                for (const [indicatorId, values] of groupedValues) {
                    ...
                    const supportedPropertyIDs = this.getValue(ctx, IndicatorCCValues.supportedPropertyIDs(indicatorId)) ?? [];
                    ...
                    if (timeout) {
                        ...
                        const metadata = {
                            ...timeoutValue.meta,
                            label: getIndicatorLabel(indicatorId, 0x06, // This is actually ignored, but pass a valid ID for clarity
                            overrideIndicatorLabel, "Timeout"),
                        };
        ...
        setIndicatorValue(ctx, value) {
            ...
            const supportedPropertyIDs = this.getValue(ctx, IndicatorCCValues.supportedPropertyIDs(value.indicatorId)) ?? [];
            if (!supportedPropertyIDs.includes(value.propertyId))
                return;
            // Publish the value
            const valueV2 = IndicatorCCValues.valueV2(value.indicatorId, value.propertyId);
...
· indicatorId: ${v.indicatorId}
  ...
  value:       ${v.value}`)
    ...
    return IndicatorCCReport = _classThis;
})();
export { IndicatorCCReport };
let IndicatorCCGet = (() => {
    let _classDecorators = [CCCommand(IndicatorCommand.Get), expectedCCResponse(IndicatorCCReport)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = IndicatorCC;
    var IndicatorCCGet = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            IndicatorCCGet = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor(options) {
    ...
    return IndicatorCCGet = _classThis;
})();
export { IndicatorCCGet };
let IndicatorCCSupportedReport = (() => {
    let _classDecorators = [CCCommand(IndicatorCommand.SupportedReport)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = IndicatorCC;
    var IndicatorCCSupportedReport = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            IndicatorCCSupportedReport = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor(options) {
        ...
        static from(raw, ctx) {
            ...
            if (bitMaskLength === 0) {
                ...
                supportedProperties = parseBitMask(raw.payload.subarray(3, 3 + bitMaskLength), 0).filter((v) => v !== 0);
            }
            return new this({
                nodeId: ctx.sourceNodeId,
                indicatorId,
        ...
        persistValues(ctx) {
            ...
            if (this.indicatorId !== 0x00) {
                ...
                this.setValue(ctx, IndicatorCCValues.supportedPropertyIDs(this.indicatorId), this.supportedProperties);
            }
            return true;
        }
        indicatorId;
            ...
            return {
                ...
                message: {
                    ...
                    "supported properties": `${this.supportedProperties
                        .map((id) => getIndicatorProperty(id)?.label
                        ?? `Unknown (${num2hex(id)})`)
                        .join(", ")}`,
    ...
    return IndicatorCCSupportedReport = _classThis;
})();
export { IndicatorCCSupportedReport };
...
let IndicatorCCSupportedGet = (() => {
    let _classDecorators = [CCCommand(IndicatorCommand.SupportedGet), expectedCCResponse(IndicatorCCSupportedReport, testResponseForIndicatorSupportedGet)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = IndicatorCC;
    var IndicatorCCSupportedGet = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            IndicatorCCSupportedGet = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor(options) {
    ...
    return IndicatorCCSupportedGet = _classThis;
})();
export { IndicatorCCSupportedGet };
let IndicatorCCDescriptionReport = (() => {
    let _classDecorators = [CCCommand(IndicatorCommand.DescriptionReport)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = IndicatorCC;
    var IndicatorCCDescriptionReport = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            IndicatorCCDescriptionReport = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor(options) {
        ...
        persistValues(ctx) {
            if (!super.persistValues(ctx))
                return false;
            if (this.description) {
                this.setValue(ctx, IndicatorCCValues.indicatorDescription(this.indicatorId), this.description);
            }
            return true;
        }
        serialize(ctx) {
    ...
    return IndicatorCCDescriptionReport = _classThis;
})();
export { IndicatorCCDescriptionReport };
...
let IndicatorCCDescriptionGet = (() => {
    let _classDecorators = [CCCommand(IndicatorCommand.DescriptionGet), expectedCCResponse(IndicatorCCDescriptionReport, testResponseForIndicatorDescriptionGet)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = IndicatorCC;
    var IndicatorCCDescriptionGet = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            IndicatorCCDescriptionGet = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor(options) {
    ...
    return IndicatorCCDescriptionGet = _classThis;
})();
export { IndicatorCCDescriptionGet };
