...
export declare function isActuatorCC(cc: CommandClasses): boolean;
/**
...
export declare function isSensorCC(cc: CommandClasses): boolean;
/**
...
export declare function isApplicationCC(cc: CommandClasses): boolean;
/**
...
export declare function isEncapsulationCC(cc: CommandClasses): boolean;
/**
...
export declare function isManagementCC(cc: CommandClasses): boolean;
/**
...
export declare function isCCInfoEqual(a: CommandClassInfo, b: CommandClassInfo): boolean;
