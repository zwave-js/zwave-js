...
import { ProvisioningInformationType, } from "./definitions.js";
...
export function readLevel(qr, offset) {
...
export function readUInt8(qr, offset) {
...
export function readUInt16(qr, offset) {
...
export function parseTLVData(type, data) {
    switch (type) {
