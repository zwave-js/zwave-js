...
export function getNotificationName(type) {
...
export function getNotificationValue(notification, value) {
    return (notification.events.get(value)
...
export function getNotificationEventName(type, event) {
    const notification = getNotification(type);
...
export function getNotificationValueName(type, event) {
    const notification = getNotification(type);
