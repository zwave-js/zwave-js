...
import { MultiStageCallback as MultiStageCallback_2 } from '@zwave-js/serial';
...
//
// @public (undocumented)
export class EnterBootloaderRequest extends Message_2 {
    // (undocumented)
    expectsAck(): boolean;
}
...
export class Message {
    ...
    expectsNodeUpdate(ctx: GetNode<NodeId & SupportsCC>): boolean;
...
export class SendDataBridgeRequest<CCType extends CommandClass = CommandClass> extends SendDataBridgeRequestBase implements MessageWithCC {
    ...
    getNodeId(): number | undefined;
    // (undocumented)
    isExpectedNodeUpdate(ctx: GetNode<NodeId & SupportsCC>, msg: Message_2): boolean;
...
//
// @public (undocumented)
export function serializableTXReportToTXReport(report: SerializableTXReport): TXReport;
