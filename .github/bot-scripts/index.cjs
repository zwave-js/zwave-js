module.exports = {
	...
	extractLogfileInDiscussion: (...args) => require("./extractLogfileInDiscussion.cjs")(...args),
	ensureLogfileFeedback: (...args) => require("./ensureLogfileFeedback.cjs")(...args),
	ensureLogfileFeedbackInDiscussion: (...args) => require("./ensureLogfileFeedbackInDiscussion.cjs")(...args),
